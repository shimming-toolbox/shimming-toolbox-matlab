...
% =========================================================================
Params.projectDir = '/home/vhosuser/Projects/Shimming/Acdc' ;

% =========================================================================
%  
% =========================================================================
Params.dataLoadDir  = [Params.projectDir '/data'] ;
...
% -------
% for shimming:
Params.pathToShimReferenceMaps = '/home/vhosuser/Projects/Shimming/Acdc/AcdcReferenceMaps20171107.mat' ;
Params.shimSystem='Acdc';

%Path to Matlab folder
Params.matlabPath='/home/vhosuser/Projects/Shimming/Acdc/MATLAB';
...
Params.calltoSortdata=sprintf('%s','matlab -nodesktop -nojvm -r ", SortData(''');
...
Params.feedbackcalibrationcoeffy = [25.456, -9.088, 5.456, 25.456, 30.91, 7.272, -19.09, 34.546]; %Calibration coefficient to transfor
