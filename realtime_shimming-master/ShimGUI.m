...
% Last Modified by GUIDE v2.5 23-Jan-2017 16:26:17
...
set(handles.runtime,'String','5*60');
handles.RecParams.runTime = 5*60;
...
handles.Params.pressureLogFilename = [handles.Params.dataLoadDir datestr(now,30) '-pressureLog-Breathing-ShimOff.bin'] ;
handles.Params.sampleTimesFilename = [handles.Params.dataLoadDir datestr(now,30) '-sampleTimes-Breathing-ShimOff.bin'] ;
[pressureLog, sampleTimes] = Probe.recordandplotpressurelog( handles.Params ) ;
