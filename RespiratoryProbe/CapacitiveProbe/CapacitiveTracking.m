classdef CapacitiveTracking < ProbeTracking 
% CapacitiveTracking - Respiratory probe for real-time shimming 
%
% Aux = CAPACITIVETRACKING(  )
%
%   Aux contains fields
%           
%       .ComPort    
...
methods
% =========================================================================
function Aux = CapacitiveTracking( Specs )

if nargin < 1
    Specs = [] ;
end

[Aux.ComPort, Aux.Specs] = CapacitiveTracking.declareprobe( Specs ) ;
